/**
 * File: /src/decorators/injectScopes.decorator.ts
 * Project: @risserlabs/nestjs-keycloak
 * File Created: 05-11-2022 12:16:14
 * Author: Clay Risser
 * -----
 * Last Modified: 06-11-2022 04:54:22
...
export const InjectScopes = createParamDecorator((_data: unknown, context: ExecutionContext) => {
