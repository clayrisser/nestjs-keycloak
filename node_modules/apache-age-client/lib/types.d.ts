 ...
 */
export declare type AgeRecord = Record<string, any>;
export declare type Flavor = "AGE";
...
export declare type Path = (Vertex | Edge)[];
export declare type Result = Record<string, Vertex | Edge | Path | null>;
